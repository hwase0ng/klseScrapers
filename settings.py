...
CHROME_DIR = ''
EXCLUDE_LIST = 'ACEINNO,ATTA,BJMEDIA,CAP,CLIQ,CLOUD,CSL,EIG,JMEDU,HLCAP,HUAAN,IKHMAS,KINSTEL,LEBTECT,LYC,MPCORP,NPS,PETONE,RALCO,SLIC,SONA,SUMATEC,TIMWELL,WINTONI,XINHE,XINQUAN,YEELEE,YFG'
