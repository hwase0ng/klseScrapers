...
CHROME_DIR = ''
EXCLUDE_LIST = 'ACEINNO,ATTA,CAP,CLIQ,CLOUD,CSL,EIG,FOCUSP,JMEDU,HLCAP,KINSTEL,LEBTECT,LYC,MPCORP,NPS,PETONE,RALCO,SLIC,SONA,SUMATEC,TIMWELL,WINTONI,XINHE,XINQUAN,YFG'
